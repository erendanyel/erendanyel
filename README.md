...
- 🧠 **AI & Automation** – agents, data parsing, workflow optimization  
- 🌐 **Web & APIs** – Python, TypeScript, FastAPI, REST, Playwright  
- 🐳 **DevOps Tools** – Docker, GCP, async concurrency, scraping frameworks  
- 🎨 **Creative Tech** – mixing AI with games, web visuals, or storytelling  
...
[![](https://visitcount.itsvg.in/api?id=erendanyel&icon=0&color=0)](https://visitcount.itsvg.in)
